...
hs.hotkey.bind(mash, '2',     function() hs.window.focusedWindow():move(units.leftBotm,    nil, true) end)
hs.hotkey.bind(mash, '3',     function() hs.window.focusedWindow():move(units.rightTop,    nil, true) end)
...
hs.hotkey.bind(mash, 'left',  function() hs.window.focusedWindow():move(units.centerLeft,  nil, true) end)
hs.hotkey.bind(mash, 'right', function() hs.window.focusedWindow():move(units.centerRight, nil, true) end)
